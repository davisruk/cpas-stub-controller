...
import { PageDetail, ToteSummary, ToteSummaryPage } from './tote-summary.model';
...
export const selectPageResponseDetail = createSelector(selectPageDetail, (state: PageDetail) => state.pageResponseDetail);
